namespace Scripts.UI
{
    ...
    public class ComUIListScript : MonoBehaviour
    {
        ...
        private void OnDestroy()
        {
            ...
            OnItemRecycle = null;
            if(null != this.m_scrollRect)
            {
                this.m_scrollRect.onValueChanged.RemoveListener(OnValueChanged);
        ...
        public void AutoScroll2Bottom()
        {
            if ((this.m_listType == enUIListType.Horizontal) || (this.m_listType == enUIListType.HorizontalGrid))
            {
                ...
                RectTransform parent = this.m_contentRectTransform.parent as RectTransform;
                this.m_contentRectTransform.anchoredPosition = new Vector2(parent.rect.width - this.m_contentRectTransform.sizeDelta.x, 0.0f);
            }
            else
            {
                this.m_scrollValue = new Vector2 { x = 0.0f, y = 1.0f };
                RectTransform parent = this.m_contentRectTransform.parent as RectTransform;
                this.m_contentRectTransform.anchoredPosition = new Vector2(parent.rect.height - this.m_contentRectTransform.sizeDelta.y, 0.0f);
            }
        }
        ...
        {
            if(m_isInitialized && m_dirty_update)
